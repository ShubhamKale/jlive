      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            $options_manufacturers = array("atm","bank","cinema","education","food","garden","hospital","hotel","medical","petrol","sport","transport","tempplaces");
				
            echo form_open('admin/places', $attributes);
				if(isset($this->session->userdata['orderid'])){
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              ...
              foreach($manufacturers as $row)
              {
				...
				if($row['verified']==1)
				{
					echo '<td><img src="'.base_url().'/assets/img/verify.png"></td>';
				}
				else
				{
					echo '<td><img src="'.base_url().'/assets/img/notverify.png"></td>';
				}
